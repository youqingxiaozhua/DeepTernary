...
from .utils import pmap_multi, read_strings_from_txt, log
...
class PDBBind(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.lig_structure_graph:
            ...
            # return lig_graph, rec_graph, lig_coords, rec_graph.ndata['x'], new_pocket_coords, pocket_coords, geometry_graph, self.complex_names[idx], idx
            return {
                'lig_graph': lig_graph,
                'rec_graph': rec_graph,
                'lig_coords': lig_coords,
                'rec_coords': rec_graph.ndata['x'],
                'lig_pocket_coords': new_pocket_coords,
                'rec_pocket_coords': pocket_coords,
